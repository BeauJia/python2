...
print '-' * 10
print "NY States has %s" % ex39_hashmap.get(cities, 'NY')
print "OR States has %s" % ex39_hashmap.get(cities, 'OR')
...
# can you do this no one line?
city = ex39_hashmap.get(cities, 'TX', 'Does Not Exist')
print "The city for the sate 'TX' is: %s" % city
# print "The city for the sate 'TX' is: %s" % \
# ex39_hashmap.get(cities, 'TX', 'Does Not Exist')
